import random
from discount_policy import DiscountPolicy, AbsoluteDiscount, PercentageDiscount
# from discount_policy import default_policy
from order_element import OrderElement
from product import Product
from errors import ElementLimitError
...
class Order:
    ...
    def add_product_to_order(self, product, quantity):
        if len(self._order_elements) >= Order.MAX_ELEMENTS:
            raise ElementLimitError(order_limit = Order.MAX_ELEMENTS)
        else:
